#include<stdio.h> //Utilizado para iniciar a criação do código.
#include<stdlib.h> //Para utilizar uma biblioteca (lib = Library)
#include<stdbool.h> //Usamos para trabalhar com valores booleano
#include<assert.h> //É utilizada para verificar se uma informação é FALSE
